            ...
            <div class="container">
                ...
                <div class="text-center">
                    ...
                    <div class="row align-items-stretch mb-5">
                        <div class="col-md-6">
                            <div class="form-group">
                                <input class="form-control" name="userID" type="text" placeholder="ID" required="required" data-validation-required-message="Please enter your ID." />
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class="form-group">
                                <input class="form-control" name="userPassword" type="password" placeholder="Password" required="required" data-validation-required-message="Please enter your password." />
                                <p class="help-block text-danger"></p>
                            </div>
                    ...
                    <div class="text-center">
                        ...
                        <input type="submit" class="btn btn-primary btn-xl text-uppercase" id="sendMessageButton" value="&nbsp &nbsp LOGIN &nbsp &nbsp" >
                        <input type="button" onClick="location.href='join.do'" class="btn btn-primary btn-xl text-uppercase" id="sendMessageButton" value="&nbsp &nbsp JOIN &nbsp &nbsp" >
                    </div>
            </form>
            </div>
        </section>
