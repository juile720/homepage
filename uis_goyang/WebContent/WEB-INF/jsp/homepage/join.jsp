...
<body>
	<div class="container">
		...
		<div class="cal-lg-4">
			<div class="jumbotron" style="text-align: center;" style="padding-top: 20px;" >
				<form method="post" action="joinAction.do">
					...
					<div class="form-group" style="text-align: center;">
						<div class="but-group" data-toggle="buttons">
					...
					<div class="checkDiv">
						...
						<p class="check">기업마당은 「개인정보보호법」 제15조제1항제1호, 제17조제1항제1호, 제23조제1호, 제24조제1항 제1호에 따라
