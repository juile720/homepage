...
public class vMapController {
	...
	protected String loginAction(ModelMap model) throws Exception {		
		
		return "/../homepage/loginAction"; 
	}
	
	//로그인 화면 호출
	@RequestMapping(value="/login.do")  
	protected String login(ModelMap model) throws Exception {		
	...
	protected String join(ModelMap model) throws Exception {		
	...
	protected String index(ModelMap model) throws Exception {		
